...
static keyboard_layout const *keyboard_layouts[] = {
	...
	[CMMK_LAYOUT_FR_S] = &layout_fr_s,
	[CMMK_LAYOUT_FR_L] = &layout_fr_l,
	[CMMK_LAYOUT_FR_MK750] = &layout_fr_mk750,
	[CMMK_LAYOUT_FR_CK530] = &layout_fr_ck530,
};
...
static int cmmk_try_determine_layout(struct cmmk *dev, int product)
{
	...
	switch (product) {
		...
		case CMMK_USB_CK530: device_model = CMMK_PRODUCT_CK530; break;
	}
	...
	if (general_layout == CMMK_LAYOUT_TYPE_ANSI) {
		switch (device_model) {
			...
			case CMMK_PRODUCT_CK530: return CMMK_LAYOUT_US_S;
		}
	} else {
		switch (device_model) {
			...
			case CMMK_PRODUCT_CK530: return CMMK_LAYOUT_EU_S;
		}
		/*switch (device_model) {*/
			/*case CMMK_PRODUCT_MASTERKEYS_PRO_L: return CMMK_LAYOUT_FR_L;*/
			/*case CMMK_PRODUCT_MASTERKEYS_PRO_S: return CMMK_LAYOUT_FR_S;*/
			/*case CMMK_PRODUCT_MASTERKEYS_MK750: return CMMK_LAYOUT_FR_MK750;*/
			/*case CMMK_PRODUCT_CK530: return CMMK_LAYOUT_FR_CK530;*/
		/*}*/
	}
